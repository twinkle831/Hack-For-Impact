  ...
  const features = [
    {
      ...
      description:
        "Identifies fights, theft, and vandalism from CCTV and mobile recordings.",
      icon: <SafetyOutlined />,
      link: "/features#crime-detection",
    },
    {
      title: "Real-Time Alerts",
      description:
        "Sends instant notifications to law enforcement and security teams.",
      icon: <FireOutlined />,
    ...
    },
    {
      ...
      description:
        "AI recommends alternative routes based on crime data and surveillance.",
      icon: <DashboardOutlined />,
      link: "/features#route-suggestions",
    },
    {
      title: "Emergency Panic Alerts",
      description:
        "Trigger alerts via button press, voice command, or gesture.",
      icon: <PhoneOutlined />,
      link: "/features#panic-alerts",
    },
    {
      title: "Legal Assistance Chatbot",
      description: "Provides easy-to-understand legal rights and support.",
      icon: <FileTextOutlined />,
      link: "/features#legal-assistance",
    },
    {
      title: "Decentralized Security",
      description:
        "Blockchain ensures anonymous and tamper-proof incident reporting.",
      icon: <UserOutlined />,
      link: "/features#decentralized-security",
    },
  ];
    ...
    <Layout className="min-h-screen bg-[#0A192F] text-white">
      ...
      <Header className="bg-[#112240] flex justify-between items-center px-6 shadow-lg border-b border-gray-600">
        ...
        <Menu
          theme="dark"
          mode="horizontal"
          className="bg-[#112240] text-white border-none"
          selectedKeys={[]}
        >
          {[
            {
      ...
      <Content
        ...
        style={{
          backgroundImage:
            "url('https://www.centraliamo.gov/sites/g/files/vyhlif13891/files/media/police/image/7601/crime_prevention.jpg')",
      ...
      >
        ...
        >
          Real-time crime detection, panic alerts, and legal support at your
          fingertips.
        </motion.p>
        <Button
          type="primary"
          size="large"
          className="mt-6 text-2xl bg-blue-600 border-none"
          onClick={scrollToFeatures}
        >
          Get Started
        </Button>
